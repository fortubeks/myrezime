...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                <div class="row">
                    <h4 class="fs-20 mb-3">Your Dashboard</h4>
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mt-4 align-items-center">
                                    <div class="col-xl-9 col-sm-12">
                                        <h4 class="fs-20 mb-3">Your Cover Letters</h4>
                                        
                                        
                                    </div>
                                    <div class="col-xl-3 col-sm-12 text-right">
                                        <!-- Button added here -->
                                        <button type="button" style="background-color: white; color: #007bff; border: 1px solid #007bff; padding: 10px 20px; font-size: 16px; cursor: pointer; border-radius: 5px;">
                                            View Cover Letters
                                        </button>
                                    </div>
                                </div>
